...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-material/src/utils/date-util';
  import ElScrollbar from 'element-ui-material/packages/scrollbar';
  import RepeatClick from 'element-ui-material/src/directives/repeat-click';

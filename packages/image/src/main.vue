...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from 'element-ui-material/src/utils/dom';
  import { isString, isHtmlElement } from 'element-ui-material/src/utils/types';
